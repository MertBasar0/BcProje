        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleManager = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GeneralManager = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ComNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleCount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "AnotherCompanyProducts",
                columns: table => new
                {
                    AnotherProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnotherCompanyProducts", x => x.AnotherProductId);
                    table.ForeignKey(
                        name: "FK_AnotherCompanyProducts_Customers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnotherCompanyProducts_CustomerId",
                table: "AnotherCompanyProducts",
                column: "CustomerId");
